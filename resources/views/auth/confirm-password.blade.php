...
<head>
    ...
    <title>Confirm Password - BilliardClub</title>
        ...
        <div class="w-full max-w-md">
            ...
            <div class="text-center mb-8 opacity-0 fade-in-up">
                ...
                <div class="inline-flex items-center gap-2 px-4 py-2 bg-[#1C4D8D]/10 border border-[#1C4D8D]/30 rounded-full backdrop-blur-sm mb-4">
                    ...
                    <span class="text-sm font-semibold text-[#5B9FD8]">Secure Area</span>
                </div>
                    ...
                    <div class="bg-[#1C4D8D]/10 border border-[#1C4D8D]/30 rounded-2xl p-4">
                        <div class="flex items-start gap-3">
                            ...
                            <p class="text-sm text-blue-300">
                                For your security, please verify your identity by entering your password before accessing this area.
                            </p>
                        </div>
                    </div>
            ...
            <div class="mt-6 text-center opacity-0 fade-in-up delay-300">
                <p class="text-gray-500 text-sm">
                    Having trouble? 
                    <a href="{{ route('password.request') }}" class="text-[#5B9FD8] hover:text-[#1C4D8D] font-semibold transition-colors">
                        Reset Password
                    </a>
                </p>
            </div>
